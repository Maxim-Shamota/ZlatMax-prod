        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (document.documentElement.classList.contains("_sub-menu-open")) document.documentElement.classList.remove("_sub-menu-open");
                }
            }));
        }
        function menuClose() {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    if (handle) toValue.value = values[handle]; else fromValue.value = values[handle];
                }));
            }));
        }
        rangeInit();
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        const currenrSlide = document.querySelector(".fraction-controll__current");
                        currenrSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : swiper.realIndex + 1;
                    }
                }
            });
